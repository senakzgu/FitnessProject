...
namespace FitnessApp.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public IActionResult Cancel(int id)
        {
            ...
            // -------------------------
            // 1) Randevu zamanı DateTime'a dönüştürülüyor
            // -------------------------
            ...
            {
                // ONAYLI → 8 saat kuralı uygulanır
                var hoursLeft = (appointmentDateTime - now).TotalHours;

                if (hoursLeft < 8)
                {
                    TempData["Error"] = "Onaylanan randevular randevu saatine 8 saatten az kaldığında iptal edilemez.";
                    return RedirectToAction("MyAppointments");
                }
            }
            // -------------------------
            // 3) ONAYSIZ → her zaman iptal edilebilir
            // -------------------------
